      ...
      case 'overview':
        return <div className="space-y-20">
            ...
            <div className="text-center space-y-8 mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-6xl mx-auto leading-relaxed">Traditional 11+ practice gives you results asa a percentage. We do things differently here: 
<br></br>We don't just mark papers, we identify the type of mistake they're making, fixing misconceptions at the source</p>
            </div>
     ...
     Targeted practice that actually identifies and fixes misconceptions: Less Repetition, More Learning.
                      </p>
                    </div>
