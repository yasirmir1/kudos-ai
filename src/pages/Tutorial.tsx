          ...
          <div className="space-y-20">
            ...
            <div className="bg-primary text-primary-foreground py-20 rounded-2xl my-[60px]">
              <div className="max-w-5xl mx-auto px-6 text-center space-y-8">
                ...
                <p className="text-xl opacity-90">
                  Stop guessing what your child needs to work on: work smarter, not harder.
                </p>
              </div>
            </div>
            ...
            <div className="text-center space-y-8 mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-6xl mx-auto leading-relaxed">
                ...
                We don't just mark papers, we identify the type of mistake they're making, fixing misconceptions at the source
              </p>
            </div>
