  ...
  return <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <main className="container mx-auto px-4 py-6">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          }} className="relative px-8 py-8 bg-zinc-100">
                
                <div className="relative z-10 flex items-center justify-between h-full">
                  {/* Left side - Welcome message and icon */}
                  <div className="flex items-center gap-6">
                    <div className="w-16 h-16 backdrop-blur rounded-2xl flex items-center justify-center bg-slate-200">
                      <svg className="w-10 h-10 text-white" fill="none" stroke="black" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                      </svg>
                    </div>
                    <div className="flex items-center">
                      <h1 className="text-4xl font-bold text-slate-700">Welcome back, {user.name}!</h1>
                    </div>
                  </div>
                </div>
              </div>
