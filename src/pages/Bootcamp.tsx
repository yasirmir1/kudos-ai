            ...
            backgroundColor: '#5947e8'
                ...
                <div className="relative z-10 flex items-center justify-between h-full">
                  ...
                  <div className="flex items-center gap-6">
                    <div className="w-10 h-10 bg-white/10 backdrop-blur flex items-center justify-center rounded-sm">
                    ...
                    <div className="flex items-center">
                      <h1 className="font-bold text-white text-2xl">Welcome back, {user.name}!</h1>
                    </div>
                  </div>
                </div>
              </div>
