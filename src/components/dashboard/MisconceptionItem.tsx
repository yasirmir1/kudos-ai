...
export const MisconceptionItem: React.FC<MisconceptionItemProps> = ({
  ...
  return <div className="px-4 py-4 rounded-lg border bg-muted/30 cursor-pointer hover:bg-muted/50 hover:border-primary/50 transition-all duration-200" onClick={onClick}>
      <div className="flex items-center justify-between gap-6">
        ...
        <div className="flex-1 min-w-0">
          ...
          {misconception.topics && misconception.topics.length > 0 && <p className="text-xs text-muted-foreground mt-2">
        ...
        <div className="flex items-center gap-6 flex-shrink-0 pr-2">
          <CircularProgress value={errorRate} size={48} color="destructive" />
