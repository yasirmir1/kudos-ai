-- Insert curriculum content for Reading and Writing Large Numbers topic
...
(
    ...
    'Learn the fundamental concepts and theory', 
    '{
...
(
    ...
    'Work through examples step by step with guidance', 
    '{
        "activities": [
            {
                "type": "step_by_step",
...
-- Insert sample questions for the curriculum content
...
SELECT 
    ...
    1,
    'multiple_choice',
    'Which number represents "three million, two hundred fifty thousand, forty-six"?',
    '["3,250,046", "3,025,046", "3,250,460", "30,250,046"]'::jsonb,
    'A',
    'Break it down: 3 million = 3,000,000, 250 thousand = 250,000, 46 = 46. Combined: 3,250,046',
    'medium',
    2
FROM bootcamp_curriculum_content bcc 
WHERE bcc.topic_id = 'npv1' AND bcc.stage_type = 'assessment';