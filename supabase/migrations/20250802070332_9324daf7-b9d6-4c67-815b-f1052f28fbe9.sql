...
('ex2', 'Assessment', 'Common mistakes assessment questions', 'assessment', 4,
 '{"questions": [{"question": "What is a common mistake when adding decimals?", "type": "multiple_choice", "options": ["Adding digits in the wrong place", "Rounding too early", "Not lining up decimal points", "All of the above"]}, {"question": "Why is it important to check units in answers?", "type": "written_answer"}]}', 3),
...
('ex4', 'Assessment', 'Mock exam assessment', 'assessment', 4,
 '{"text": "Complete a full mock exam to demonstrate your exam skills and readiness."}', 60)
