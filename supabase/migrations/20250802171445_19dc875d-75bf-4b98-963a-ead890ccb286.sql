-- Add missing enum values for cognitive_level
...
WHERE q.option_a IS NOT NULL AND q.question_id IN (
    'Q008', 'Q010', 'Q011', 'Q012', 'Q013', 'Q014', 'Q015', 'Q016',
    'Q017', 'Q018', 'Q019', 'Q020', 'Q021', 'Q022', 'Q023', 'Q024',
    'Q025', 'Q026', 'Q027', 'Q028', 'Q029', 'Q030', 'Q031', 'Q032',
    'Q033', 'Q034'
);

-- Insert B, C, D options
INSERT INTO bootcamp_answer_options (question_id, option_letter, answer_value, is_correct, misconception_code, diagnostic_feedback)
SELECT 
    q.question_id,
    'B' as option_letter,
...
FROM bootcamp_questions q
WHERE q.option_b IS NOT NULL AND q.question_id IN (
    'Q008', 'Q010', 'Q011', 'Q012', 'Q013', 'Q014', 'Q015', 'Q016',
    'Q017', 'Q018', 'Q019', 'Q020', 'Q021', 'Q022', 'Q023', 'Q024',
    'Q025', 'Q026', 'Q027', 'Q028', 'Q029', 'Q030', 'Q031', 'Q032',
    'Q033', 'Q034'
...
SELECT 
    ...
    'Review the solution method if this was your choice' as diagnostic_feedback
FROM bootcamp_questions q
WHERE q.option_c IS NOT NULL AND q.question_id IN (
    'Q008', 'Q010', 'Q011', 'Q012', 'Q013', 'Q014', 'Q015', 'Q016',
    'Q017', 'Q018', 'Q019', 'Q020', 'Q021', 'Q022', 'Q023', 'Q024',
    'Q025', 'Q026', 'Q027', 'Q028', 'Q029', 'Q030', 'Q031', 'Q032',
    'Q033', 'Q034'
...
SELECT 
    ...
    'Review the solution method if this was your choice' as diagnostic_feedback
FROM bootcamp_questions q
WHERE q.option_d IS NOT NULL AND q.question_id IN (
    'Q008', 'Q010', 'Q011', 'Q012', 'Q013', 'Q014', 'Q015', 'Q016',
    'Q017', 'Q018', 'Q019', 'Q020', 'Q021', 'Q022', 'Q023', 'Q024',
    'Q025', 'Q026', 'Q027', 'Q028', 'Q029', 'Q030', 'Q031', 'Q032',
    'Q033', 'Q034'
