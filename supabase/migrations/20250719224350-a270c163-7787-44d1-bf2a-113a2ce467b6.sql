-- Insert Year 5 curriculum data with proper array formatting
...
('Y5GS001', 'Geometry - Properties of Shapes', 'Identify 3-D shapes from 2-D representations', 'Which 3-D shape has 6 square faces?', 'Multiple Choice', '["Cube", "Cuboid", "Pyramid", "Sphere"]', 'Cube', 'Easy', ARRAY['3DShape_PropertyError'], 'Student may confuse cube with cuboid (rectangular faces).', 'Year 5: Identifying 3D shapes by properties.', 'year 4-5', 5),
