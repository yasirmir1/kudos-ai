...
CREATE INDEX idx_misconception_queue_status ON bootcamp_misconception_queue(status, priority);
CREATE INDEX idx_misconception_patterns_key ON bootcamp_misconception_patterns(pattern_key);
CREATE INDEX idx_explanation_cache_key ON bootcamp_explanation_cache(cache_key);
CREATE INDEX idx_student_responses_misconception ON bootcamp_student_responses(student_id, misconception_detected);
